...
class MyTheme {
  ...
  static const Color accent50 = Color(0x77F47A20);
  static const Color accent80 = Color(0xAAF47A20);
  static const Color canvasColor = Color(0xFF212121);
  static const Color border = Color(0xFFCCCCCC);
  static const Color idColor = Color(0xFFE06A12);
  static const Color darkGray = Color.fromARGB(255, 148, 148, 148);
  static const Color cmIdColor = Color(0xFF21790B);
  static const Color dark = Colors.black87;
  static const Color button = Color(0xFFF47A20);
...
void checkUpdate() {
  // ЭЛЕРОЗ: обновления берутся с нашего сайта, поэтому проверка работает и у своего клиента.
  if (!isWeb) {
